...
class TraccarClientExtendedEntity(CoordinatorEntity[TraccarClientExtendedCoordinator]):
    ...
    def __init__(
        ...
        self._attr_device_info = DeviceInfo(
            ...
            # Shows as "Connected via" on the device page. The integration
            # page nests by sub-entry and ignores this, which is why grouping
            # by model is done with sub-entry titles instead.
            via_device=coordinator.hub_identifier,
        )
